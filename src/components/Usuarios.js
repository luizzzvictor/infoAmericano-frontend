...
function Usuarios() {
  ...
  .filter((Usuario) => Usuario.name.toLowerCase().includes(search.toLowerCase()))
  .map((Usuario) => {
      return (
          <tr key={Usuario._id}>
              ...
              <td className="p-1">{Usuario.orgao}</td>
            ...
            <Modal show={show} onHide={handleClose} animation={true}>
                ...
                <Modal.Body>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Group className="mb-3 lh-1 fw-bold">
                            <Form.Label>Código do Órgão: </Form.Label>
                            <Form.Control type="text"
                                placeholder="Código do órgão (tabela CNJ)"
                                name="orgao" value={form.orgao} onChange={handleChange}
                                onBlur={handleBlur}
                            />
                        </Form.Group>
                        ...
                        <div className="row">
                            <div className="col-4">
                                <Form.Group className="mb-3 lh-1 fw-bold" style={{width: '120px'}}>
                                    ...
                                    <Form.Control type="text"
                                        name="confirmEmail" value={form.confirmEmail} onChange={handleChange}
                                        onBlur={handleBlur}
                                    />
                                </Form.Group>
                            </div>
                            <div className="col-4">
                                <Form.Group className="mb-3 lh-1 fw-bold" style={{width: '120px'}}>
                                    ...
                                    <Form.Control type="text"
                                        name="aprovadouser" value={form.aprovadoUser} onChange={handleChange}
                                        onBlur={handleBlur}
                                    />
                                </Form.Group>
                            </div>
                            <div className="col-4">
                                <Form.Group className="mb-3 lh-1 fw-bold" style={{width: '120px'}}>
                                    ...
                                    <Form.Control type="text"
                                        name="active" value={form.active} onChange={handleChange}
                                        onBlur={handleBlur}
                                    />
                                </Form.Group>
                            </div>
                ...
                <Table className="mt-4" bordered hover>
                    <thead>
                        <tr>
                            ...
                            <th onClick={ () => classifica('email','text') } className="text-center">
                              <div className="d-flex">
                                <div className='col-11'>E-mail</div>
                                <div className='col-1'> <FontAwesomeIcon style={{color: "blue"}} icon={faUpDown}/> </div>
                              </div>
                            </th>
                            <th onClick={ () => classifica('telefone','text') } className=" text-center">
                              <div className="d-flex">
                                <div className='col-11'>Telefone</div>
                                <div className='col-1'> <FontAwesomeIcon style={{color: "blue"}} icon={faUpDown}/> </div>
                              </div>
                            </th>
                            <th onClick={ () => classifica('role','text') } className=" text-center">
                              <div className="d-flex">
                                <div className='col-11'>Tipo</div>
                                <div className='col-1'> <FontAwesomeIcon style={{color: "blue"}} icon={faUpDown}/> </div>
                              </div>
                            </th>
                            <th onClick={ () => classifica('orgao','text') } className=" text-center">
                              <div className="d-flex">
                                <div className='col-11'>Cod. Órgão</div>
                                <div className='col-1'> <FontAwesomeIcon style={{color: "blue"}} icon={faUpDown}/> </div>
                              </div>
                            </th>
                            <th onClick={ () => classifica('ConfirmEmail','text') } className=" text-center">
                              <div className="d-flex">
                                <div className='col-11'>E-mail Conf.</div>
                                <div className='col-1'> <FontAwesomeIcon style={{color: "blue"}} icon={faUpDown}/> </div>
                              </div>
                            </th>
                            <th onClick={ () => classifica('aprovadoUser','text') } className=" text-center">
                              <div className="d-flex">
                                <div className='col-11'>Usuário Aprov.</div>
                                <div className='col-1'> <FontAwesomeIcon style={{color: "blue"}} icon={faUpDown}/> </div>
                              </div>
                            </th>
                            <th onClick={ () => classifica('active','text') } className=" text-center">
                              <div className="d-flex">
